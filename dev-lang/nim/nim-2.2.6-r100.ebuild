...
EOF
	...
	PATH="./bin:${PATH}" nim c -d:release --listCmd --parallelBuild:$(makeopts_jobs) -o:bin/nimsuggest nimsuggest/nimsuggest.nim || die "nimsuggest compilation failed"
...
src_install() {
	...
	insinto /usr/share/nim/lib/packages/compiler
	doins -r dist
