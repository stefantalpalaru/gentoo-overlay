...
PATCHES=(
	"${FILESDIR}/hedgewars-1.0.0-cmake_lua_version.patch"
	"${FILESDIR}/hedgewars-1.0.2-respect-cc.patch"
	"${FILESDIR}/hedgewars-1.0.2-metainfo.patch"
	"${FILESDIR}/hedgewars-1.0.2-glext-prototypes.patch"
	"${FILESDIR}/hedgewars-1.0.2-clang-15.patch"
)
