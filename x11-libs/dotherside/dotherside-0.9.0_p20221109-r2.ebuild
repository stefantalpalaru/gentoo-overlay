...
#SRC_URI="https://github.com/filcuc/dotherside/archive/v${PV}.tar.gz -> ${P}.gh.tar.gz"
SRC_URI="https://github.com/filcuc/dotherside/archive/${MY_COMMIT}.tar.gz -> ${P}.gh.tar.gz"
