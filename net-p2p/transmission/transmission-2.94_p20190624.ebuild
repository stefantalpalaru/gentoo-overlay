...
EAPI=6
inherit autotools flag-o-matic git-r3 gnome2-utils qmake-utils systemd user xdg-utils

DESCRIPTION="A Fast, Easy and Free BitTorrent client"
HOMEPAGE="http://www.transmissionbt.com/"
EGIT_REPO_URI="https://github.com/transmission/transmission"
EGIT_COMMIT="bff188c2cfc66371eec17deca3a0529864f33663"
EGIT_SUBMODULES=(
	'*'
	'-third-party/libb64'
...
PATCHES=(
	"${FILESDIR}/default_trackers-r2.patch"
)
...
src_prepare() {
	...
	sed -i -e '/third-party\/libb64\/Makefile/d' \
		-e '/third-party\/libnatpmp\/Makefile/d' \
		-e '/third-party\/miniupnpc\/Makefile/d' \
		configure.ac
