...
SRC_URI="https://support.hdfgroup.org/ftp/HDF5/releases/${MAJOR_P}/${MY_P}/src/${MY_P}.tar.bz2"
S="${WORKDIR}/${MY_P}"
LICENSE="NCSA-HDF"
SLOT="0/${PV%%_p*}"
...
src_prepare() {
	...
	append-flags -Wno-error=implicit-function-declaration -Wno-error=incompatible-pointer-types
