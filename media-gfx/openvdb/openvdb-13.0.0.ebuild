...
inherit cmake cuda flag-o-matic llvm-r2 python-single-r1 toolchain-funcs
...
IUSE="
	...
	${CPU_FEATURES[*]%:*}
	alembic ax +blosc cuda doc examples jpeg +nanovdb numpy openexr pdal png python static-libs test utils +zlib
"

RESTRICT="!test? ( test ) cuda? ( network-sandbox )"
