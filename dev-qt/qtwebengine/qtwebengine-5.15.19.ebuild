...
PATCHES=(
	...
	"${FILESDIR}/qtwebengine-5.15.17-spellcheck.patch"
	"${FILESDIR}/qtwebengine-5.15.19-headers.patch"
	"${FILESDIR}/qtwebengine-5.15.19-icu-78.patch"
	"${FILESDIR}/qtwebengine-5.15.19-glibc-2.43.patch"
)
