...
PATCHES=(
	"${FILESDIR}"/OpenRGB-1.0-build-system.patch
	"${FILESDIR}"/OpenRGB-1.0-udev-check.patch
	"${FILESDIR}"/OpenRGB-1.0-builddate.patch
...
src_install() {
	...
	./openrgb --generate-udev-rules 60-openrgb.rules
