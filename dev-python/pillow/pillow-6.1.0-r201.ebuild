...
SRC_URI="https://github.com/python-pillow/Pillow/archive/${PV}.tar.gz -> ${P}.gh.tar.gz"
S="${WORKDIR}/${MY_P}"
LICENSE="HPND"
SLOT="python2"
...
RDEPEND="
	...
	!<dev-python/pillow-6.1.0-r1[${PYTHON_USEDEP}]
"
DEPEND="${RDEPEND}
...
PATCHES=(
	"${FILESDIR}"/${PN}-5.4.1-toolchain-paths.patch
)
