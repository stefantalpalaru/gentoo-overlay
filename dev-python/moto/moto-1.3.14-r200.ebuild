...
RDEPEND="
	>=dev-python/aws-xray-sdk-python-0.93:python2[${PYTHON_USEDEP}]
	...
	>=dev-python/docker-py-2.5.1:python2[${PYTHON_USEDEP}]
	>=dev-python/idna-2.5:python2[${PYTHON_USEDEP}]
	>=dev-python/jinja-2.10.1:python2[${PYTHON_USEDEP}]
