...
RDEPEND="
	...
	$(python_gen_cond_dep '>=dev-python/numpy-python2-1.11[${PYTHON_USEDEP}]' python2_7)
	$(python_gen_cond_dep '>=dev-python/numpy-1.11[${PYTHON_USEDEP}]' python3_{6,7})
...
DEPEND="
	...
	test? (
	   ...
	   $(python_gen_cond_dep 'sci-libs/scipy[${PYTHON_USEDEP}]' python3_{6,7})
	)
"
