...
RDEPEND=">=dev-python/zope-interface-3.6.0:python2[${PYTHON_USEDEP}]
	crypt? ( >=dev-python/pyopenssl-0.10:python2[${PYTHON_USEDEP}]
		dev-python/service_identity:python2[${PYTHON_USEDEP}] )
	gtk? ( dev-python/pygtk:2[${PYTHON_USEDEP}] )
	serial? ( dev-python/pyserial:python2[${PYTHON_USEDEP}] )
	!<dev-python/twisted-core-15.2.1-r200[${PYTHON_USEDEP}]
"
DEPEND="
	test? ( ${RDEPEND} )
"
