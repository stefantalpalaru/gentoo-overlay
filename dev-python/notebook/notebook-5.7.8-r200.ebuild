...
RDEPEND="
	...
	>=dev-python/jupyter_core-4.4.0:python2[${PYTHON_USEDEP}]
	>=dev-python/pyzmq-17:python2[${PYTHON_USEDEP}]
	>=dev-python/jupyter_client-5.2:python2[${PYTHON_USEDEP}]
	...
	dev-python/prometheus_client:python2[${PYTHON_USEDEP}]
