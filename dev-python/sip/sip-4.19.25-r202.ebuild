...
PYTHON_COMPAT=( python2_7 python3_{10..13} python3_13t )
inherit flag-o-matic python-r1 toolchain-funcs
...
PATCHES=(
	"${FILESDIR}"/${PN}-4.18-darwin.patch
	"${FILESDIR}"/sip-4.19.25-python-3.11.patch
)
