...
OPTIONAL_DEPEND="
	...
	>=dev-python/pytables-3.2.1:python2[${PYTHON_USEDEP}]
	dev-python/python-gflags:python2[${PYTHON_USEDEP}]
	dev-python/rpy:python2[${PYTHON_USEDEP}]
...
"
COMMON_DEPEND="
	>dev-python/numpy-python2-1.7[${PYTHON_USEDEP}]
...
pkg_postinst() {
	...
	optfeature "needed for pandas.io.html.read_html" dev-python/beautifulsoup:4-python2 dev-python/html5lib dev-python/lxml
