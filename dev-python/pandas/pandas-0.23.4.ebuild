...
OPTIONAL_DEPEND="
	...
	>=dev-python/google-api-python-client-1.2.0[$(python_gen_usedep python2_7)]
	|| (
	...
	$(python_gen_cond_dep 'dev-python/matplotlib[${PYTHON_USEDEP}]' python3_6)
	|| (
	...
	$(python_gen_cond_dep 'sci-libs/scipy[${PYTHON_USEDEP}]' python3_6)
	X? (
		|| (
...
COMMON_DEPEND="
	...
	$(python_gen_cond_dep '>dev-python/numpy-1.7[${PYTHON_USEDEP}]' python3_6)
